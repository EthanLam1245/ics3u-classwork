...
print(f"There are {NumberOfCansPerPack*NumberOfPacks} cans in total.")
...
print(f"The volume of this rectangular prism is {FirstDimension*SecondDimension*ThirdDimension}")
